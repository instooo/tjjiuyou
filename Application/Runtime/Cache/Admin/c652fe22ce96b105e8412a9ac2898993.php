...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Charts/regHourSpread">
            <div id="count_search">
                <ul class="search_box">
                    <li class="line">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">注册人数时段占比图说明：</span>注册人数时段占比，用于分析所选时间段内24小时每小时注册人数占总注册人数的百分比。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>
                使用者可以通过对日期选择，游戏，一级栏目，二级栏目进行自定义，选择自己想查询的数据并点击搜索按钮实现注册数据的分析图并显示各个时段内的注册人数百分比。
            </p>
        </div>
    </div>
</div>

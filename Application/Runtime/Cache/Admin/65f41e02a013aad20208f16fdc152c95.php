...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Charts/areaSpread">
            <div id="count_search">
                <ul class="search_box">
                    <li class="line">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">注册人数地域占比图说明：</span>注册人数地域占比，用于分析每个地域注册人数占总注册人数的百分比。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>
                使用者可以通过对日期选择，游戏，一级栏目，二级栏目进行自定义，选择自己想查询的数据并点击搜索按钮实现注册数据的分析图并显示各个地域内的注册人数百分比。
            </p>
        </div>
    </div>
</div>

...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Charts/reg_liucun">
            <div id="count_search">
                <ul class="search_box">
                    <li class="line">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">注册留存分析说明：</span>注册留存分析，对于当前账号显示注册留存的分析图，注册留存分析会展示某段时间的1日，2日，3日留存率 。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>
                使用者可以通过对日期选择，游戏，一级栏目，二级栏目进行自定义，选择自己想查询的数据并点击搜索按钮实现三种留存数据的分析图。
            </p>
        </div>
    </div>
</div>
...
<script>
	  $(function () {
        ...
        var charts = new Highcharts.Chart(data_source);
    });
    $(function () {

...
<script>
	 $(function () {
        ...
        var money_v = '<?php echo ($money_v); ?>';
        var num_v = '<?php echo ($num_v); ?>';
		var now_money_v = '<?php echo ($now_money_v); ?>';
        var dan_num_v = '<?php echo ($dan_num_v); ?>';
        var subtitle_money = '<?php echo ($subtitle_money); ?>';
        var subtitle_num = '<?php echo ($subtitle_num); ?>';
		var subtitle_now_money = '<?php echo ($subtitle_now_money); ?>';
        var subtitle_dan_num = '<?php echo ($subtitle_dan_num); ?>';
        var charts;
        var data_source = {
            chart: {
                renderTo: 'container',

	...
	<form name="myform" id="myform" action="">
      ...
      <div id="count_search">
		...
		<li class="bottom">
			...
			<input type="button" name="excelbtn" value="导出充值总汇Excel" id="importexcel" class="manager-btn s-btn orange-btn ml-10">	
			<input type="button" name="excelbtn" value="导出回款总汇Excel" id="importexcel1" class="manager-btn s-btn orange-btn ml-10">	
		</li>		
        </ul>
		</div>
...
<script type="text/javascript">
	...
	$('#importexcel').click(function() {
		...
		$('#end').attr('value',end);
		$('#myform').attr('action','/DataImport/real_dao').attr('method','get').submit();
	});
	$('#importexcel1').click(function() {
		...
		$('#start').attr('value',start);
		$('#end').attr('value',end);
		$('#myform').attr('action','/DataImport/back_dao').attr('method','get').submit();
	});

    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Realtime/register">
            <div class="moneyinfos clearfix">
               <p style="font-size: 18px">注册人数：<b class="price" style="font-size: 18px"><?php echo ($register_count); ?></b>人</p>
               <!--<p style="font-size: 18px">试玩激活人数：<b class="price" style="font-size: 18px"><?php echo ($trial_count); ?></b>人</p>-->
            </div>
            ...
            <div id="count_search">
                <ul class="search_box">
					...
					<li class="line">
						...
						<label class="msg">
							<input type="text" id="quick_select" name="c_keyword" value="<?php echo ($c_keyword); ?>" class="manager-input s-input">
						</label>
					</li>
            ...
            <div id="count_body">
                <table class="huitable">
                    ...
                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php if($vo['level'] == null): ?>0 <?php else: ?> <?php echo ($vo["level"]); endif; ?></td>

...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Realtime/pay_list">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">充值查询说明：</span>当前账号显示充值查询的详细信息，包括用户ID、注册时间、用户名、充值游戏、充值金额、充值时间、推广人员、充值IP和选择充值日期、注册日期内的充值金额和人数。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>使用者可以通过对充值日期、注册日期、游戏、一级栏目、二级栏目和每页条数进行自定义，点击搜索按钮，得到使用这想要的数据，可以通过“导出EXCEL”按钮导出数据。</p>
        </div>
    </div>
</div>

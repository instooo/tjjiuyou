...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Charts/down_compare">
            <div id="count_search">
                <ul class="search_box">
                    <li class="line">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">安装走势对比说明：</span>安装走势对比，对于当前账号显示安装走势的对比图，安装走势对比会展示某段时间的安装人数的对比图。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>
                使用者可以通过对两个日期选择，游戏，一级栏目，二级栏目进行自定义，选择自己想查询的数据并点击搜索按钮实现两种安装数据的对比图并显示日期内的总人数。
            </p>
        </div>
    </div>
</div>
	 ...
	 $(function () {
        ...
        $('#switch li').click(function () {
            ...
            if ($(this).find('a').attr('data') == 'money') {
                ...
                charts.setTitle({text:'每日安装人数趋势'}, {text:subtitle_register});
                ...
                charts.setTitle({text:'每日安装人数趋势'}, {text:subtitle_num});
                while (charts.series.length>0) {
                    charts.series[0].remove();
                }

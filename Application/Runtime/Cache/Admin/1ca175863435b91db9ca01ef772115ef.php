...
<div id="MainContentDIV">
    ...
    <div id="ManagerRight" class="ManagerRightShow">
        <form id="myform" name="countform" method="get" action="/Charts/down_trend">
            <div id="count_search">
                <ul class="search_box">
                    <li class="line">
        ...
        <div class="product-detail-desc mt-15">
            ...
            <p class="pt-5"><span  style="font-weight:bold;">安装走势分析说明：</span>安装走势分析，对于当前账号显示安装走势的分析图，安装走势分析会展示一段时间的安装人数的分析图。</p>
            <p class="pt-5"><span style="font-weight:bold;">使用者说明：</span>
                使用者可以通过对日期选择，游戏，一级栏目，二级栏目进行自定义，选择自己想查询的数据并点击搜索按钮实现安装数据的分析图并显示日期内的总人数。
            </p>
        </div>
    </div>
</div>
...
<script>
	$(function () {
        ...
        var register_sum = '<?php echo ($register_sum); ?>';
        ...
        $('#switch li').click(function () {
            if ($(this).find('a').attr('data') == 'money') {
                ...
                charts.setTitle({text:'每日安装人数趋势'},{text:'总人数：'+register_sum});
                charts.series[0].remove();
                charts.addSeries({name:'安装人数',data:eval("("+register_v+")"),color:'#7cb5ec',tooltip:{valueSuffix: ''}});
                charts.yAxis[0].setTitle({text:'安装人数'});
